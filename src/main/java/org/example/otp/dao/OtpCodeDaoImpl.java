...
/**
 * Реализация интерфейса доступа к данным для работы с OTP кодами
 * Обеспечивает взаимодействие с базой данных для хранения и управления одноразовыми паролями
 */
