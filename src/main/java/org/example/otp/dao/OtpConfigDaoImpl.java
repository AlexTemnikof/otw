...
/**
 * Реализация интерфейса доступа к данным для работы с конфигурацией OTP
 * Обеспечивает взаимодействие с базой данных для хранения и управления настройками одноразовых паролей
 */
